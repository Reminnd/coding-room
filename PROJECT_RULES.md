...
| 项目开发Fix/Stage acceptance与Git-write/closure authorization | 用户 |
| 项目开发mechanical verification/projection | GitHub Actions；不得替代Review、acceptance或execution authority |
