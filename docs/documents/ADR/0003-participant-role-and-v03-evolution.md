...
用户已于2026-08-29明确确认以上三项边界。Stage 1 Implementation现已通过Review、获用户接受并进入版本化`main`；只有另行获得database/binding cutover授权后，v0.3才能替代active v0.2 runtime。
